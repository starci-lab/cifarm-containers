...
import { AppearanceChance, SpinPrizeType, LowerCaseAppearanceChance, LowerCaseSpinPrizeType } from "../enums"
...
export class SpinPrizeSchema extends AbstractSchema {
    ...
    @Field(() => LowerCaseAppearanceChance, {
