...
import { PlacedItemTypeId, PlacedItemSchema, InventoryKind, InventorySchema, InventoryType, InventoryTypeSchema, SessionSchema, ToolSchema } from "@src/databases"
import { StaticService } from "@src/gameplay"
import { JwtService } from "@src/jwt"
import { createObjectId, DeepPartial } from "@src/common"
import { GraphQLError } from "graphql"
import { InitializeParams, InitializeResponse } from "./types"
...
export class InitializationService {
    ...
    async initialize({
        ...
        session,
        connection
    }: InitializeParams): Promise<InitializeResponse> {
