...
import { CropEntity, InventoryEntity, MarketPricingEntity, UserEntity } from "@src/database"
import { BuySeedsService } from "./buy-seeds.service"

@Global()
@Module({
    imports: [
        TypeOrmModule.forFeature([UserEntity, InventoryEntity, CropEntity, MarketPricingEntity]),
