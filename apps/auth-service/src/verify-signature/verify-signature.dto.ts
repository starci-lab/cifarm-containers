...
export class VerifySignatureResponse {
  @IsString()
  @ApiProperty({
      example: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhdWQiOiJteS1hcGkiLCJzdWIiOiIxMjM0NTY3ODkwIiwiaWF0IjoxNTE2MjM5MDIyfQ.CYKMzt2MB-2Ez0N5D93tnPYznZy2ym2NKd5XK_UQeLQ", // Example JWT access token
