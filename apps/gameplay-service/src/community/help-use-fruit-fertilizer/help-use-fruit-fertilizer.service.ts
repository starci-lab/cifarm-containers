...
import { HelpUseFruitFertilizerRequest, HelpUseFruitFertilizerResponse } from "./help-use-fruit-fertilizer.dto"
...
export class HelpUseFruitFertilizerService {
    ...
    async helpUseFruitFertilizer({ placedItemFruitId, inventorySupplyId, userId }: HelpUseFruitFertilizerRequest): Promise<HelpUseFruitFertilizerResponse> {
        ...
        try {
            const result = await mongoSession.withTransaction(async (session) => {
                ...
                if (neighborUserId === userId) {
                    ...
                    throw new GrpcFailedPreconditionException("Cannot help use fruit fertilizer on your own tile")
                }
                ...
                if (placedItemFruit.fruitInfo.currentState !== FruitCurrentState.NeedFertilizer) {
                    ...
                    throw new GrpcFailedPreconditionException("Fruit is not need fertilizer")
                }
